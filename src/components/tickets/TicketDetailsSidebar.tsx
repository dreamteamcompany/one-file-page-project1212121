...
const TicketDetailsSidebar = ({
  ...
  return (
    <div className="w-full lg:w-[400px] space-y-3 flex-shrink-0">
      ...
      {ticket.due_date && (
        <div className="p-4 rounded-lg bg-card border flex flex-col min-h-[280px] md:min-h-[340px] lg:min-h-0">
      ...
      {onSendPing && (
        <div className="p-4 rounded-lg bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800 flex flex-col justify-center min-h-[280px] md:min-h-[340px] lg:min-h-0">
