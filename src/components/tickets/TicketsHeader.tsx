...
const TicketsHeader = ({ menuOpen, setMenuOpen }: TicketsHeaderProps) => {
  return (
    <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 px-4 py-4 bg-card/50 backdrop-blur-[20px] rounded-[15px] border border-border">
